...
function generateStats(team) {
  ...
  let teamTos = 0;
  let teamFouls = 0;
  let teamFoulsDrawn = 0;
  let teamShotsRejected = 0;
  ...
  for (let index = 0; index < 12; index++) {
    ...
    let playerStats = {
      ...
      "foulDrawn": Math.floor(Math.random() * (playerMin * 0.05)),
      "shotReject": Math.floor(Math.random() * (playerMin * 0.05)),
      "min": playerMin,
    };
    ...
    teamFoulsDrawn += playerStats.foulDrawn;
    teamShotsRejected += playerStats.shotReject;
  ...
  team.stats = {
    ...
    "tos": teamTos,
    "foul": teamFouls,
    "foulDrawn": teamFoulsDrawn,
    "shotReject": teamShotsRejected,
    "min": MAX_MINUTES * 5,
  };
